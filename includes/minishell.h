...
/*   Updated: 2025/08/06 17:35:24 by jmeouchy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		handle_recirections(t_tree_node *node,
			t_envp *env, t_gc_list *grbg_collector);
...
void	one_element_input_to_list(char *input, t_list *list,
			int *start, int *i, t_gc_list *grbg_collector);
void	two_element_input_to_list(char *input, t_list *list,
			int *start, int *i, t_gc_list *grbg_collector);
...
int		split_redirections(char *input, t_list *list, int start,
			int *i, t_gc_list *grbg_collector);
int		split_symbols(char *input, t_list *list, int start,
			int *i, t_gc_list *grbg_collector);
